...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'register.askProfession': 'Please select your profession:\n1️⃣ Electrician\n2️⃣ Plumber\n3️⃣ House Work\n\nReply with: 1, 2, or 3',
        'register.askSubProfession.1': 'Please select your Electrician specialization:\n1️⃣ Wiring\n2️⃣ Appliance Repair\n3️⃣ Installation\n\nReply with: 1, 2, or 3',
        'register.askSubProfession.2': 'Please select your Plumber specialization:\n1️⃣ Pipe Leakage\n2️⃣ Bathroom Fittings\n3️⃣ Water Tank\n\nReply with: 1, 2, or 3',
        'register.askSubProfession.3': 'Please select your House Work specialization:\n1️⃣ Cleaning\n2️⃣ Cooking\n3️⃣ Babysitting\n\nReply with: 1, 2, or 3',
        'register.invalidOption': 'Invalid option selected. Please reply with a valid number.',
        'register.success': 'Registration complete! ✓\n\nName: {name}\nPhone: {phone}\nProfession: {profession}\nSpecialization: {subProfession}',
        'register.error': 'Error during registration. Please try again.',
        'register.askPhoneAdmin': 'Please enter the phone number of the worker you want to register (with country code):',
        'register.noPermission': 'You do not have permission to use this command. Only group admins can register others.',
    ...
    hi: {
        ...
        'register.askProfession': 'कृपया अपना पेशा चुनें:\n1️⃣ इलेक्ट्रीशियन (Electrician)\n2️⃣ प्लम्बर (Plumber)\n3️⃣ घर का काम (House Work)\n\nउत्तर दें: 1, 2, या 3',
        'register.askSubProfession.1': 'कृपया अपनी इलेक्ट्रीशियन विशेषज्ञता चुनें:\n1️⃣ वायरिंग (Wiring)\n2️⃣ उपकरण मरम्मत (Appliance Repair)\n3️⃣ इंस्टालेशन (Installation)\n\nउत्तर दें: 1, 2, या 3',
        'register.askSubProfession.2': 'कृपया अपनी प्लम्बर विशेषज्ञता चुनें:\n1️⃣ पाइप लीकेज (Pipe Leakage)\n2️⃣ बाथरूम फिटिंग्स (Bathroom Fittings)\n3️⃣ पानी की टंकी (Water Tank)\n\nउत्तर दें: 1, 2, या 3',
        'register.askSubProfession.3': 'कृपया घर के काम की विशेषज्ञता चुनें:\n1️⃣ सफाई (Cleaning)\n2️⃣ खाना पकाना (Cooking)\n3️⃣ बेबीसिटिंग (Babysitting)\n\nउत्तर दें: 1, 2, या 3',
        'register.invalidOption': 'अमान्य विकल्प चुना गया। कृपया सही संख्या के साथ उत्तर दें।',
        'register.success': 'पंजीकरण पूर्ण! ✓\n\nनाम: {name}\nफोन: {phone}\nपेशा: {profession}\nविशेषज्ञता: {subProfession}',
        'register.error': 'पंजीकरण के दौरान त्रुटि। कृपया फिर से कोशिश करें।',
        'register.askPhoneAdmin': 'कृपया उस कार्यकर्ता का फोन नंबर दर्ज करें जिसे आप पंजीकृत करना चाहते हैं (देश कोड के साथ):',
        'register.noPermission': 'आपके पास इस कमांड का उपयोग करने की अनुमति नहीं है। केवल समूह व्यवस्थापक (admin) दूसरों को पंजीकृत कर सकते हैं।',
